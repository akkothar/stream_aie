...
import pandas as pd
import pickle
pickleFile = open("/proj/rdi/staff/gagandee/dse/stream_aie2/outputs/saved_cn_hw_cost-aie_col-bottleneck-hintloop_oy_all.pickle","rb")

obj = pd.read_pickle(pickleFile)
# print (obj)
pickle_filepath="/proj/rdi/staff/gagandee/dse/stream_aie2/outputs/saved_cn_hw_cost-aie_col-bottleneck-hintloop_oy_all.pickle"
