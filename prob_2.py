...
results_path = "unit_tests_results/prob_2"
...
################################PATHS################################
node_hw_performances_path = f"unit_tests_results/prob_2/{node_hw_cost_pkl_name}-CN_{CN_define_mode}.pickle"
scme_path = f"unit_tests_results/prob_2/{scme_pkl_name}-CN_{CN_define_mode}.pickle"
timeline_fig_path_plotly = f"unit_tests_results/prob_2/{experiment_id}-schedule-CN_{CN_define_mode}.html"
timeline_fig_path_matplotlib = f"unit_tests_results/prob_2/{experiment_id}-schedule-CN_{CN_define_mode}.png"
memory_fig_path = f"unit_tests_results/prob_2/{experiment_id}-memory-CN_{CN_define_mode}.png"
#####################################################################
