...
results_path = "unit_tests_results/2cores-2conv-1x1-1x1"
...
################################PATHS################################
node_hw_performances_path = f"unit_tests_results/2cores-2conv-1x1-1x1/{node_hw_cost_pkl_name}-CN_{CN_define_mode}.pickle"
scme_path = f"unit_tests_results/2cores-2conv-1x1-1x1/{scme_pkl_name}-CN_{CN_define_mode}.pickle"
timeline_fig_path_plotly = f"unit_tests_results/2cores-2conv-1x1-1x1/{experiment_id}-schedule-CN_{CN_define_mode}.html"
timeline_fig_path_matplotlib = f"unit_tests_results/2cores-2conv-1x1-1x1/{experiment_id}-schedule-CN_{CN_define_mode}.png"
memory_fig_path = f"unit_tests_results/2cores-2conv-1x1-1x1/{experiment_id}-memory-CN_{CN_define_mode}.png"
#####################################################################
