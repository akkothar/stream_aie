...
if __name__ == '__main__':
    ...
    torch.onnx.export(model.eval(),               # model being run
                    ...
                    "conv1_3x3_workload.onnx", #"UNet_bottleneck_full_reduction_4_inchannel_3_without_bias.onnx",   # where to save the model (can be a file or file-like object)
    ...
    model = onnx.load('conv1_3x3_workload.onnx') #('UNet_bottleneck_full_reduction_4_inchannel_3_without_bias.onnx')
    onnx.save_model(model, 
                    'conv1_3x3_workload.onnx', #'UNet_bottleneck_full_reduction_4_inchannel_3_without_bias_save.onnx', 
    ...
    model = onnx.load('conv1_3x3_workload.onnx') #("UNet_bottleneck_full_reduction_4_inchannel_3_without_bias_save.onnx")
    inferred_model = shape_inference.infer_shapes(model)
    onnx.save(inferred_model, "conv1_3x3_workload.onnx") #"UNet_bottleneck_full_reduction_4_inchannel_3_without_bias_save_infer.onnx")